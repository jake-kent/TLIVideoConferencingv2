...
public class UserSession implements Closeable {
  ...
  public UserSession(final String name, final String roomName, final WebSocketSession session,
    ...
    this.outgoingMedia.setMinVideoRecvBandwidth(500);
    this.outgoingMedia.setMinVideoSendBandwidth(500);
    this.outgoingMedia.setMaxVideoRecvBandwidth(500);
    this.outgoingMedia.setMaxVideoSendBandwidth(500);
